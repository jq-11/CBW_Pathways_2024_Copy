...
```
<p align="center"><img src="./Module2/gsea/images/saving_gmt.png" alt="saving_gmt" width="70%" /></p>
...
<p align="center"><img src="./Module2/gsea/images/gmt_format.png" alt="get_gmt" width="70%" /></p>
...
* [Human_GOBP_AllPathways_no_GO_iea_May_24_2016_symbol.gmt](./Module2/gsea/data/Human_GOBP_AllPathways_no_GO_iea_May_24_2016_symbol.gmt)
...
<img src="./Module2/gsea/images/launchGSEA3.0.png" alt="Launch GSEA" width="100%" />
...
<img src="./Module2/gsea/images/GSEAloaddata.png" alt="Load data" width="100%" />
...
2d. Click on *Choose*. A message pops us when the files are loaded successfully. 
	<p align="center">
		<img src="./Module2/gsea/images/ORA4.png" alt="Locate files" width="50%" />
	</p>
...
```{block, type="rmd-tip"}
set *Enrichment Statistics* to p1 if you want to add more weight on the most top up-regulated and top down-regulated. *P1* is a more stringent parameter and it will result in less gene-sets significant under FDR <0.05.
```
...
<p align="center">
<img src="./Module2/gsea/images/ORA15.png" alt="Results3" width="75%" />
</p>

<p align="center">
<img src="./Module2/gsea/images/ORA16.png" alt="Results4" width="75%" />
</p>
