...
The pathways are organized in main categories and clicking on the left arrow will display the sub-categories. 
...
- Transform it into a network and back to a diagram. Right-click on a blank space of the diagram and select **Convert to FI Network**. It has the advantage that we can now work with this network and use the Cytoscape analysis and visual features.
...
- Open the diagram from the Reactome website:
  Locate the menu of pathways on the left window and right click on **Erythrocytes take up carbon dioxide and release oxygen**. Select **View in Reactome**. It will open a new page in your web browser. 
...
- ***Browse*** and upload the **Pan_Cancer_drivers.txt** file ,click **OK**. 
...
The statistical enrichment test pvalue associated with this pathway is close to 0 (0.00968) and it means that this size of the overlap (42 genes) is not likely to be obtained by chance only. 
...
- Transform the diagram into a network:
  Right-click on a blank space of the diagram and select **Convert to FI Network**. 
  
  The advantage of a network is that we can now use the Cytoscape analysis and visual features. Purple-coloured nodes reflect genes that are present in our input gene list.
...
- Transform it back into a diagram:
Right-click on a blank space and select **Convert to Diagram**. 
...
- Open Reactome Reacfoam: 
  The Reacfoam view provides a holistic view of all (exclude disease) human pathways in the Reactome database. Go to the menu of pathways in the Control Panel (left window) and right-click on a blank space. Select **Open Reactome Reacfoam**.   
<p align="center">
...
We remember that this gene list comes from genes found with frequently mutated in diverse types of cancer. Interestingly, this network might show us that although they were found in different cancers, they might be biologically connected and might function in common biological pathways and protein complexes and represent hallmarks of cancer.
...
The FI network was constructed by merging interactions extracted from human curated pathways with interactions predicted using a machine learning approach. The non curated sources of information include protein-protein interactions, gene coexpression, protein domain interaction, Gene Ontology (GO) annotations and text-mined protein interactions.Solid edge between 2 nodes are interaction from curated pathways and dashed line are predicted interaction. (https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2898064/).
...
- **Redo the layout for clarity**: Go to Cytoscape menu bar, select **Layout** and then **yFiles Organic Layout**.
...
- Click on a solid line. Tip: you might need to zoom in to do it. Once it is highlighted in red, right click on it and select **ReactomeFI** and **Query FI Source**. 

  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_12.png" alt="start" width="80%" />
 </p>
 
 It will reveals a name of pathway in which this interaction is included as well as some reference papers for the interaction.
 
   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_13.png" alt="start" width="80%" />
 </p>
 
- Click on a dashed line.  Once it is highlighted in red, right click on it and select **ReactomeFI** and **Query FI Source**.

   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_14.png" alt="start" width="80%" />
 </p>
 
 It will include the score for the prediction of the interaction.
...
``` 
 ...
 - To get an information about a gene. Right-click on a gene and select **ReactomeFI** and **Query Gene Card**
...
- In the Cytoscape menu bar, select **Import**, **Table from File...**

  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_17.png" alt="start" width="100%" />
 </p>
 
 In the window **Import Columns From Table**, make sure that **Import Data as:** is set to **Node Table Columns**. Click **OK**.
 
   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_18.png" alt="start" width="100%" />
 </p
...
- Look for the **Style** tab in the Control Panel located at the left of the Cytoscape window. Select.

- Click on the down arrow beside **Properties** and select **Size** on the list.


   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_19.png" alt="start" width="100%" />
 </p>
 
 - Select the **Size** field and expand it using the down arrow.
- In the  **Column** field, click on **--select value--** and choose **BLCA Freq**. 

   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_21.png" alt="start" width="100%" />
 </p>
 
- In the **Mapping Type**, click on **--select value--** and choose **Continuous Mapping**.
- Click on the diagram

   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_22.png" alt="start" width="100%" />
 </p>
 

- Set the first pivot **Handle Position** and the second pivot **Handle Position** to 100
- Click OK
 
 
   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_23.png" alt="start" width="100%" />
 </p>
...
### Play with style: change transparency and colors
...
- In some colors are too dark, it is possible to modify the cluster color but selecting the field **Fill Color** in properties:
  - double-click on a color and choose the new one.
   <p align="center">
...
As we have the mutation frequencies for several cancer types, that would be useful to be able to compare all cancers on the same network. It is possible by plotting a pie chart for each gene (node) with each pie slice representing the mutation frequency for each cancer. 
Here are the steps to do it:

- In Style, click on the down arrow close to **Properties** and select **Paint**, **Custom Paint1** and **Image/Chart 1**. 
  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_31.png" alt="start" width="100%" />
 </p>
 
 - A **Graphics** windows pops up. In **Chart**, select the bargraph icon.
 - In **Available Columns**, select the columns that you want to include in your pie chart (here 8 cancer types) and click on the arrow.

  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_32.png" alt="start" width="100%" />
 </p>

- They are now placed in the **Selected Columns** window. Click on **Apply**.

  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_33.png" alt="start" width="100%" />
 </p>
 
 ```{block, type="rmd-tip"}
 Expanding **Customize** will open a tab that shows the color legend for the pie chart. It is customizable. 
 ```
 
  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_35b.png" alt="start" width="100%" />
 </p>
...
### Create a subnetwork
 ...
 - Now that the network is clustered in modules and related pathways, we want to create a subnetwork to highlight connections that we found interesting. For this exercise, we want to do a network of the genes involved in the **Gastric cancer (K)** pathway. 

Here are the steps to follow:
 - In the table panel, locate the **Pathways in Network** table. It will highlight the genes in this pathway in yellow.
 - Above the network find and click on the **New Network from Selection** icon and select **From Selected Nodes, All Edges**. 
 
   <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_39.png" alt="start" width="100%" />
 </p>
 
```{block, type="rmd-tip"}
In order to generate the pathway network table, right-click on a blank space, **ReactomeFI**, **Analyze Network Functions**, **Pathway Enrichment**.
``` 
...
The numerous drugs known to target genes in this subnetworks are now added to the networkk as green diamond shaped nodes.

  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_44.png" alt="start" width="100%" />
 </p>
...
- In the Cytoscape menu, select **File**, **Export**, **Network to Image**. 
  ...
  <p align="center">
 <img src="./Module4/Reactome/images/lab2/ReactomeFI_ex2_41.png" alt="start" width="100%" />
 </p>
