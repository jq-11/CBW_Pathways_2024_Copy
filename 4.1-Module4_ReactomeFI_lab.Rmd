...
- In Cytoscape, locate the menu bar, select File -> Close .  (This will clear the previous session we created in 1A in order to start with a clean slate.)
...
A little quirk in the ReactomeFI app.  In order to see the context menu with all your options you need to have a pathway selected.  
