...
The "annotations" are shown as larger node labels.

<img src="./Module3/gsea/images/EM13.png" alt="EM" width="750" />

**6a**. To modify these precomputed annotations find the Auto annotate Display panel on the right or Auto annotate input panel left.
