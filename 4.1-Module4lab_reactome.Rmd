# Module 4 Lab: Reactome {#reactome_lab}
...
## Aim
This exercise will provide you with an opportunity to perform pathway and network analysis using the Reactome Functional Interaction (FI) and the ReactomeFIViz app. 

## Goal
Analyze gene lists and somatic mutation data to identify biology that contributes to GBM and ovarian cancer.
...
1. Open up Cytoscape.   
  ...
  f. Upload/Browse [GBM_genelist.txt](./Module4/Reactome/data/GBM_genelist.txt) into Reactome Pathway Enrichment Analysis, and click “OK”.   
...
1. Open up Cytoscape.   
  ...
  c.	Upload/Browse [GBM_genesample.txt](./Module4/Reactome/data/GBM_genesample.txt) file.   
...
1.	Open up Cytoscape.   
  a.	Go to Apps>Reactome FI and Select “Gene Set/Mutational Analysis”.    
  b.	Choose “2018 (Latest)” Version.   
  c.	Upload/Browse [OVCA_TCGA_MAF.txt](./Module4/Reactome/data/OVCA_TCGA_MAF.txt) file.   
...
11.	How many modules are statistically significant in the CoxPH analysis?   
  a.	Hint: Analyze Module Functions>Survival Analysis>Upload/Browse [OVCA_TCGA_Clinical.txt](./Module4/Reactome/data/OVCA_TCGA_Clinical.txt). Click OK.  
...
[Answer key](#reactome_lab_answers)
