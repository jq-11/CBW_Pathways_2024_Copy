# Module 6 Lab: GeneMANIA (web version) {#genemania_web}
...
Right click on link below and select "Save Link As...".<br>
...
9. Re-run an analysis by adding SORT1, HSPG2 to the search. Click on SORT1, click on Add  ![add](./Module6/genemania/images/add.png) or type the name of the gene in the search box. Do the same for HSPG2.  The genes are now added to the search box and a new network is automatically created.  Which functions are associated with this new network ![circle](./Module6/genemania/images/circle.png)? 	 
...
11. Choose your favorite layout and save the  network as an image  using the *Network image As Shown* option from the *save*  menu ![save](./Module6/genemania/images/save.png).  	

## EXERCISE 1 ANSWERS: DETAILED EXPLANATION AND SCREENSHOTS

### EXERCISE 1 - STEPS 1-4

![GM1](./Module6/genemania/images/GM1.png) 

### EXERCISE 1 - STEP 5

![GM2](./Module6/genemania/images/GM2.png) 
 
### EXERCISE 1 - STEP 6

![GM3](./Module6/genemania/images/GM3.png)  

### Exercise 1 - STEP 7

![GM4](./Module6/genemania/images/GM4.png)  
...
![GM5](./Module6/genemania/images/GM5.png)

![GM6](./Module6/genemania/images/GM6.png)   

### Exercise 1 - STEP 10 (layouts)

#### Circular layout

![GM7](./Module6/genemania/images/GM7.png) 
 
#### Aligned layout
 
![GM8](./Module6/genemania/images/GM8.png) 
 
#### Force directed layout
 
![GM9](./Module6/genemania/images/GM9.png) 

### Exercise 1 - STEP 11 (save an image) 	

![GM10](./Module6/genemania/images/GM10.png)  
...
3.	Copy and paste genes in the file [30_prostate_cancer_genes.txt](./Module6/genemania/data/30_prostate_cancer_genes.txt).  Make sure that the parameter 'Max resultant genes' is set to '20' by clicking on the 3 menu buttons at the right side of the search box and selecting 'Customise advanced options'.	
...
![GM12](./Module6/genemania/images/GM12.png)  


```{block, type="rmd-tip"}
check that the parameter 'Max resultant genes' is set to '20':
![GM12](./Module6/genemania/images/GM12_v2.png)  
```

### Exercise 2 - STEP 5
	
![GM13](./Module6/genemania/images/GM13.png) 
 

### Exercise 2 - STEP 6.

![GM14](./Module6/genemania/images/GM14.png)  


### Exercise 2 - STEP 7

	
![GM15](./Module6/genemania/images/GM15.png) 

![GM16](./Module6/genemania/images/GM16.png) 


### Exercise 2 - STEP 8

![GM17](./Module6/genemania/images/GM17.png) 


![GM18](./Module6/genemania/images/GM18.png) 
...
![GM19](./Module6/genemania/images/GM19.png) 
...
![GM20](./Module6/genemania/images/GM20.png) 
 
![GM21](./Module6/genemania/images/GM21.png) 
...
![GM22](./Module6/genemania/images/GM22.png)  

### Exercise 2 - STEP 12

	
![GM23](./Module6/genemania/images/GM23.png) 

![GM24](./Module6/genemania/images/GM24.png) 

![GM25](./Module6/genemania/images/GM25.png) 
...
![GM26](./Module6/genemania/images/GM26.png) 
 
**How to get the 30 prostate cancer gene list**:

![GM27](./Module6/genemania/images/GM27.png)   
...
![GM28](./Module6/genemania/images/GM28.png) 

![GM29](./Module6/genemania/images/GM29.png)  

 
### Exercise 3 - STEP 4


![GM30](./Module6/genemania/images/GM30.png)  


### Exercise 3 - STEP 5


![GM31](./Module6/genemania/images/GM31.png)  


### Exercise 3 - STEPS 6 

![GM32](./Module6/genemania/images/GM32.png) 

![GM33](./Module6/genemania/images/GM33.png)  

 
### Exercise 3 - STEP 7
	

![GM34](./Module6/genemania/images/GM34.png)  

### Exercise 3 - STEP 8

![GM35](./Module6/genemania/images/GM35.png) 

![GM36](./Module6/genemania/images/GM36.png)  

 
### Exercise 3 - STEP 9


![GM37](./Module6/genemania/images/GM37.png)  
