...
The first piece of information that we need to get before starting the analysis is the model organism and genome version. 
...
* If needed, you can use the finalized formatted file [GSE128767_RUNX1_ChIP.peaks.fasta](./Module5/chipseqlab/chipseqlab_data/GSE128767_RUNX1_ChIP.peaks.fasta) **but we encourage you to follow the below steps to learn how to do it yourself**.
