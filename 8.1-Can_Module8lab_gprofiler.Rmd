# Module 08 -1 lab - g:Profiler {#CANgprofiler-lab}
...
* [cluster3.txt](./Can_Module8/images/cluster3.txt)
...
Paste the gene list ([cluster3.txt](./Can_Module8/images/cluster3.txt)) into the Query field in top-left corner of the screen. 
...
The data used in this exercise is pathway enrichment result from the list of genes that we found in cluster 3 in  [exercise 1](#exercise-1). 
 ...
 * Adjust the colors so it corresponds to the single cell RNAseq UMAP plot (see top of the document for reference).
