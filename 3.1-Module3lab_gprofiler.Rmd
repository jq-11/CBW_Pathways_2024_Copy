# Module 3: g:profiler Visualization {#gprofiler_mod3}
...
## Data
<!---Absolute path - should be relative but github.io not configured correctly--->
...
1. Enrichment result 1: [gProfiler_hsapiens_GEM1.txt](./Module3/gprofiler/data/gProfiler_hsapiens_GEM1.txt) 
In g:Profiler, the parameters that we used were: GO_BP no electronic annotation, Reactome, Benjamini-HochBerg FDR 0.05. 

1. Enrichment result 2: [gProfiler_hsapiens_gs250.gem.txt](./Module3/gprofiler/data/gProfiler_hsapiens_gs250.gem.txt) 
...
1. Enrichment result 3: [gProfiler_hsapiens_Baderlab_max250_gem.txt](./Module3/gprofiler/data/gProfiler_hsapiens_Baderlab_max250_gem.txt)

1. Pathway database 1 (.gmt):[hsapiens_GO_REAC.gmt](./Module3/gprofiler/data/hsapiens_GO_REAC.gmt)
...
1. Pathway database 2 (.gmt):[Human_GOBP_AllPathways_no_GO_iea_June_20_2019_symbol_max250gssize.gmt](./Module3/gprofiler/data/Human_GOBP_AllPathways_no_GO_iea_June_20_2019_symbol_max250gssize.gmt)
