...
Five files are needed for this exercise:
  ...
  * In g:Profiler, the parameters that we used to generate this file were:
    ...
    * The results were filtered using the g:Profiler Term size slidebar and only the enriched gene-sets that contain more than 3 or equal or less than 10000 genes per gene-set were included in the result file. 
  ...
  * In g:Profiler, the parameters that we used were: 
    ...
    * WikiPathways,
    * Benjamini-HochBerg FDR 0.05. 
    * The results were filtered using the g:Profiler Term size slidebar and only the enriched gene-sets that contain more than 3 and equal or less than 250 genes per gene-set were included in the result file.
