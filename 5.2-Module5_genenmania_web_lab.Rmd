...
2. In the search window, ensure that the model organism is set to *Homo sapiens* ![homo](./Module5/genemania/images/Up.png).  

3. Enter the following gene: GRN	

4. Click on the search icon ![search](./Module5/genemania/images/Search.png) and wait for the results.	

5. When your search results load, examine the network. Genes you searched with are indicated with stripes, related genes added by GeneMANIA are represented in black, and colored links represent the interactions that connect the nodes (genes). **Tip**: zoom in and zoom out using trackpad or mouse scrolling up and down using the mouse or trackpad or zoom in to the maximum using the specific icon ![arrow](./Module5/genemania/images/arrow.png).
...
7. Locate the Functions summary tab (bottom left icon ![circle](./Module5/genemania/images/circle.png)). What are the functions significantly associated with  this network?  GRN is the central node of this network: which function would you predict for GRN? How well did GeneMANIA perform (hints: use GeneCards (<http://www.genecards.org/>) , PubMed (<http://www.ncbi.nlm.nih.gov/pubmed/>))?	

8. Locate the gene with the strongest association with GRN. **Tip**: this gene is the largest node on the network. 	

9. Re-run an analysis by adding SORT1, HSPG2 to the search. Click on SORT1, click on Add  ![add](./Module5/genemania/images/add.png) or type the name of the gene in the search box. Do the same for HSPG2.  The genes are now added to the search box and a new network is automatically created.  Which functions are associated with this new network ![circle](./Module5/genemania/images/circle.png)? 	 

10. On the left side of the window are located icons that we haven’t yet explored. The first 3 buttons are activating different network layouts. Try the circular ![circular](./Module5/genemania/images/circledot.png), the aligned ![aligned](./Module5/genemania/images/twodown.png), and the force_directed ![force](./Module5/genemania/images/crossing.png) layouts.  	

11. Choose your favorite layout and save the  network as an image  using the *Network image As Shown* option from the *save*  menu ![save](./Module5/genemania/images/save.png).  	

## EXERCISE 1 ANSWERS: DETAILED EXPLANATION AND SCREENSHOTS

### EXERCISE 1 - STEPS 1-4

![GM1](./Module5/genemania/images/GM1.png) 

### EXERCISE 1 - STEP 5

![GM2](./Module5/genemania/images/GM2.png) 
 
### EXERCISE 1 - STEP 6

![GM3](./Module5/genemania/images/GM3.png)  

### Exercise 1 - STEP 7

![GM4](./Module5/genemania/images/GM4.png)  
...
![GM5](./Module5/genemania/images/GM5.png)

![GM6](./Module5/genemania/images/GM6.png)   

### Exercise 1 - STEP 10 (layouts)

#### Circular layout

![GM7](./Module5/genemania/images/GM7.png) 
 
#### Aligned layout
 
![GM8](./Module5/genemania/images/GM8.png) 
 
#### Force directed layout
 
![GM9](./Module5/genemania/images/GM9.png) 

### Exercise 1 - STEP 11 (save an image) 	

![GM10](./Module5/genemania/images/GM10.png)  
...
![GM11](./Module5/genemania/images/GM11.png) 
...
```	
7.	Locate and expand the 'Networks' summary tab (on the right ![lines](./Module5/genemania/images/threelines.png)) and look at what data has been used to create the network and predictions. 
```{block, type="rmd-note"}
...
9.	Locate the Functions summary tab (bottom left ![circle](./Module5/genemania/images/circle.png)) and look at what functions were  significantly enriched in this list of prostate genes.	

10.	“Shared protein domains” is an important part of the network. What would be the GeneMANIA results if we don’t include this source when we run GSEA? Click on ‘Show advanced option ![options](./Module5/genemania/images/dotdotdot.png)’ which is located at the right of the search box. Uncheck ‘Shared protein domains’ and click on the search icon ![search](./Module5/genemania/images/Search.png). Explore the results.
	
11.	Locate the Functions summary tab (bottom left ![circle](./Module5/genemania/images/circle.png)) and look at what functions were  significantly enriched with these new settings.	
...
13.	Try additional parameters of the ‘Customise advanced options ![options](./Module5/genemania/images/dotdotdot.png)’ tab and look at how the changes you made influenced the results. For example change ‘Network weighting’ method or ‘Max resultant genes: ’.  	
...
![GM12](./Module5/genemania/images/GM12.png)  


```{block, type="rmd-tip"}
check that the parameter 'Max resultant genes' is set to '20':
![GM12](./Module5/genemania/images/GM12_v2.png)  
```

### Exercise 2 - STEP 5
	
![GM13](./Module5/genemania/images/GM13.png) 
 

### Exercise 2 - STEP 6.

![GM14](./Module5/genemania/images/GM14.png)  


### Exercise 2 - STEP 7

	
![GM15](./Module5/genemania/images/GM15.png) 

![GM16](./Module5/genemania/images/GM16.png) 


### Exercise 2 - STEP 8

![GM17](./Module5/genemania/images/GM17.png) 


![GM18](./Module5/genemania/images/GM18.png) 
...
![GM19](./Module5/genemania/images/GM19.png) 
...
![GM20](./Module5/genemania/images/GM20.png) 
 
![GM21](./Module5/genemania/images/GM21.png) 
...
![GM22](./Module5/genemania/images/GM22.png)  

### Exercise 2 - STEP 12

	
![GM23](./Module5/genemania/images/GM23.png) 

![GM24](./Module5/genemania/images/GM24.png) 

![GM25](./Module5/genemania/images/GM25.png) 
...
![GM26](./Module5/genemania/images/GM26.png) 
 
**How to get the 30 prostate cancer gene list**:

![GM27](./Module5/genemania/images/GM27.png)   
...
3.	Copy and paste genes in the file [Mixed_gene_list.txt](https://github.com/bioinformatics-ca/bioinformatics-ca.github.io/raw/master/2016_workshops/pathways/module5_lab/mixed_gene_list.txt). Click on the search icon ![search](./Module5/genemania/images/Search.png)    and wait for the results.	

4.	Locate the Functions summary tab (bottom left ![circle](./Module5/genemania/images/circle.png)) and look at functions returned by GeneMANIA	
...
6.	We are going next to add miRs and drug interaction networks. Click on ‘Show advanced option   ![options](./Module5/genemania/images/dotdotdot.png)’ which is located at the right of the search box. In the 'Networks' tab, expand 'Attributes' and check “Drug-interactions-2013” and “miRNA-target-predictions-2013”. Check “Physical interactions” and “Co-expression” . Click on “Customise advanced options”. Set “Max resultant genes” to 20 and “Max resultant attributes” to 40. Click on the search icon ![search](./Module5/genemania/images/Search.png)    and wait for the results. Explore the network. **Tips**: the Drug-interactions and miRNA-target-predictions nodes are displayed in gray. The nodes connected to a drug are genes that are targeted by the drug and nodes connected to a  microRNA (miR) are genes predicted to be targeted by this miR.	
...
8.	Generate and save a report of your results by locating the save menu ![save](./Module5/genemania/images/save.png), and selecting “Report”. The PDF report provides a detailed description of your search and results.	

9.	Investigate the “history” function by clicking on the related icon ![redo](./Module5/genemania/images/redo.png) located at the bottom of the window. A panel pops up showing the past networks generated by GeneMANIA. Clicking on one panel will relaunch the search for this network. 	

## Exercise 3: MORE DETAILS AND SCREENSHOTS

### Exercise 3 - STEPS 1 - 3

![GM28](./Module5/genemania/images/GM28.png) 

![GM29](./Module5/genemania/images/GM29.png)  

 
### Exercise 3 - STEP 4


![GM30](./Module5/genemania/images/GM30.png)  


### Exercise 3 - STEP 5


![GM31](./Module5/genemania/images/GM31.png)  


### Exercise 3 - STEPS 6 

![GM32](./Module5/genemania/images/GM32.png) 

![GM33](./Module5/genemania/images/GM33.png)  

 
### Exercise 3 - STEP 7
	

![GM34](./Module5/genemania/images/GM34.png)  

### Exercise 3 - STEP 8

![GM35](./Module5/genemania/images/GM35.png) 

![GM36](./Module5/genemania/images/GM36.png)  

 
### Exercise 3 - STEP 9


![GM37](./Module5/genemania/images/GM37.png)  
