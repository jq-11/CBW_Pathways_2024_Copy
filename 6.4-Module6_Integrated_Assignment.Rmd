...
**Answer**: extracellular matrix/structure organization
...
## PART 6: iRegulon
  ...
  * Using your GSEA map at q-value 0.01, select all nodes from the extracellular matrix organization node. Go to Table Panel (below the main window), and click on the menu icon (located on the right, 3 lines) and click on 'Export as TXT' (all genes). Save the text file under the name 'extracellularmatrix_cluster_genes.txt' or use this file [extracellular_matrix_organization.txt](./IntegratedAssignment/data/extracellular_matrix_organization.txt).
  ...
  * Browse your computer and select the 'extracellular_matrix_organization.txt' file and click on open.
...
<img src="./IntegratedAssignment/images/reactome1_2021.png" alt="reactome1_2021.png" width="750" />
...
<img src="./IntegratedAssignment/images/IN_genemania_output.png" alt="genemania_output.png" width="750" />
...
<img src="./IntegratedAssignment/images/IAgenemaniahandle.png" alt="IAgenemaniahandle.png" width="750" />
...
<img src="./IntegratedAssignment/images/IAgenemania2.png" alt="IAgenemania2.png" width="750" />


<img src="./IntegratedAssignment/images/genemaniaresult2.png" alt="genemaniaIP2.png" width="750" />
...
<img src="./IntegratedAssignment/images/string.png" alt="string_2021.png" width="750" /> 
